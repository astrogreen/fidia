...
urlpatterns = [
    url(r'^sign-in/$', views.login, {'template_name': 'rest_framework/login.html'}, name='login'),
    url(r'^sign-out/$', views.logout, {'template_name': 'user/logout/logout.html'}, name='logout'),
]
