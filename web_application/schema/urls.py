...
router.register(r'data-access/schema', schema.views.SchemaViewSet, base_name='root')

# Nested routes for sample ()
sample_nested_router = NestedExtendDefaultRouter(router, r'data-access/schema', lookup='root')
sample_nested_router.register(r'(?P<survey_pk>[^/]+)', schema.views.SurveyViewSet, base_name='survey')
