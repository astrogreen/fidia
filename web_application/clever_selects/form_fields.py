...
class ChainedChoiceFieldMultiple(ChoiceField):
    def __init__(self, parent_field, ajax_url, choices=None, empty_label='--------', *args, **kwargs):
        ...
        defaults = {
            'widget': ChainedSelect(parent_field=parent_field, ajax_url=ajax_url, attrs={'empty_label': empty_label, 'multiple':'true'}),
        }
        defaults.update(kwargs)

        super(ChainedChoiceFieldMultiple, self).__init__(choices=self.choices, *args, **defaults)
