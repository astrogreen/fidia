...
class ReturnColumns(ChainedChoicesForm):
    ...
    testSurvey=forms.ChoiceField(choices=[('GAMA','GAMA'),('SAMI','SAMI')], label='Survey')
    testCat=forms.ChoiceField(choices=[('GAMA-CAT','GAMA-CAT'),('SAMI-CAT','SAMI-CAT')], label='Catalogue')
    testColumns=forms.ChoiceField(choices=[('GAMA-CAT-COLS','GAMA-CAT-COLS'),('SAMI-CAT-COLS','SAMI-CAT-COLS')], label='Columns')